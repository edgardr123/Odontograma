...
public class PacienteForm implements Serializable {
    ...
    @ApiObjectField(name = "apellidoP", description = "Apellido Paterno del paciente", required = true)
    @NotBlank
    @Size(max = 50)
    private String apellidoP;

    @ApiObjectField(name = "apellidoM", description = "Apellido Materno del paciente", required = true)
    @NotBlank
    @Size(max = 50)
    ...
    @ApiObjectField(name = "codigoPostal", description = "Codigo postal del paciente", required = true)
    @NotBlank
    @Size(max = 50)
